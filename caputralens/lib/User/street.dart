        ...
        child: Column(children: [
           Container(
                      ...
                      child: Padding(
                        ...
                        child: Text("City Chronicles: Where Every Corner Holds a Story, Every Snapshot Captures the Urban Soul.",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
                      ),
                    ),
        ]),
       ),
