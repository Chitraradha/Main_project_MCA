...
class FineArtPage extends StatefulWidget {
  const FineArtPage({super.key});

  @override
  State<FineArtPage> createState() => _FineArtPageState();
}

class _FineArtPageState extends State<FineArtPage> {
  @override
        ...
        child: Column(children: [
           Container(
                      ...
                      child: Padding(
                        ...
                        child: Text("Ethereal Elegance in Every Frame: Where Photography Meets Artistry, Creating Timeless Masterpieces",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
                      ),
                    ),
        ]),
       ),
