        ...
        child: Column(children: [
           Container(
                      ...
                      child: Padding(
                        ...
                        child: Text("Faces that Tell a Thousand Stories: Capturing the Essence of You in Every Click.",style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic)),
                      ),
                    ),
        ]),
       ),
