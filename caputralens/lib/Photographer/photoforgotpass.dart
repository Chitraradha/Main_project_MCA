...
class PhotoforgotPass extends StatefulWidget {
  const PhotoforgotPass({super.key});

  @override
  State<PhotoforgotPass> createState() => _PhotoforgotPassState();
}

class _PhotoforgotPassState extends State<PhotoforgotPass> {
  @override
