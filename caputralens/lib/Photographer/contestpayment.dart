...
class ContestPayment extends StatefulWidget {
  const ContestPayment({super.key});

  @override
  State<ContestPayment> createState() => _ConestPaymentState();
}

class _ConestPaymentState extends State<ContestPayment> {
  @override
